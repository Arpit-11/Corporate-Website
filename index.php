...
<div class="px-4 pt-5 my-5 text-center border-bottom">
    ...
    <div class="overflow-hidden" style="max-height: 30vh;">
      <div class="container ">
        <img class="hero_image" src="<?php bloginfo('template_directory'); ?>/aboutus.png" class="img-fluid border rounded-3 shadow-lg mb-4 about-img" alt="Example image" width="700" height="500" loading="lazy">
      </div>
    </div>
  </div>
</section>
...
<script src="<?php bloginfo('template_directory');?>/js/script.js">
</body>
